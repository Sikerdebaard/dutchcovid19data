...
data_output_path = Path('./data/hospitalized')
...
parser_mappings = {
    ...
    'died-and-survivors-cumulative': alt_date_based_data_to_xlsx,
    'global': global_to_xlsx,
    'age-distribution-died-and-survivors': alt_distribution_to_xlsx,
    'age-distribution-status': alt_distribution_to_xlsx,
    'behandelduur-distribution': alt_distribution_to_xlsx,
}

name_mappings = {
    'died-and-survivors-cumulative': ['cumulative_deceased', 'cumulative_recovered'],
    'new-intake': ['confirmed', 'not-confirmed'],
    'age-distribution-died-and-survivors': ['patients_deceased', 'patients_recovered'],
    'age-distribution-status': ['patients_in_hospital', 'patients_recovered', 'patients_deceased'],
    'behandelduur-distribution': ['patients_in_hospital', 'patients_recovered', 'patients_deceased'],
}
...
resp = get(f'{stichting_nice_url}/js/covid-19-zkh.js')
done_urls = []
